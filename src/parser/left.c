    ...
    case TokenIdentifier:
        {
            ...
            if (streq(token.trace.source, str("extern")))
            {
                ...
                if (!try
                (parser->tokenizer, TokenIdentifier, &external_token)
                )
                {
    ...
    case '[':
        {
            ...
            *pointer->StructLiteral.type = (Node)
            {
                .
                Postfix = {
            ...
            push(&slice->StructLiteral.fields, new_node((Node)
            {
                .
                External = {
                    .compiler = (void*)&comp_External,
            ...
            push(&slice->StructLiteral.field_names, (str)
            {
                0
            }
            )
