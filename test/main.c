...
struct _UnwrappedVector__char { char* data; size_t size; size_t capacity; };
struct Slice__struct_str { struct str* data; size_t size; };
struct Range { size_t start; size_t end; };
struct String { struct _UnwrappedVector__char vector; };
